...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnClientWakeUp' ->
            'encode_msg_eventssidecar.v1.OnClientWakeUp'(id(Msg, TrUserData), TrUserData);
        'google.protobuf.Timestamp' ->
            'encode_msg_google.protobuf.Timestamp'(id(Msg, TrUserData), TrUserData)
    end.

'encode_msg_eventssidecar.v1.OnClientWakeUp'(Msg, TrUserData) ->
    'encode_msg_eventssidecar.v1.OnClientWakeUp'(Msg, <<>>, TrUserData).

'encode_msg_eventssidecar.v1.OnClientWakeUp'(
    #'eventssidecar.v1.OnClientWakeUp'{
                ...
                begin
                    ...
                    if
                        TrF1 =:= undefined ->
                            Bin;
                        true ->
                            'e_mfield_eventssidecar.v1.OnClientWakeUp_timestamp'(
...
decode_msg_2_doit('eventssidecar.v1.OnClientWakeUp', Bin, TrUserData) ->
    id('decode_msg_eventssidecar.v1.OnClientWakeUp'(Bin, TrUserData), TrUserData);
...
'decode_msg_eventssidecar.v1.OnClientWakeUp'(Bin, TrUserData) ->
    'dfp_read_field_def_eventssidecar.v1.OnClientWakeUp'(
        Bin,
        0,
        0,
        0,
...
'dfp_read_field_def_eventssidecar.v1.OnClientWakeUp'(
    ...
    'd_field_eventssidecar.v1.OnClientWakeUp_timestamp'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnClientWakeUp'(
    <<18, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
) ->
    'd_field_eventssidecar.v1.OnClientWakeUp_client_id'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnClientWakeUp'(
    <<26, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
) ->
    'd_field_eventssidecar.v1.OnClientWakeUp_mountpoint'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnClientWakeUp'(
    <<34, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
) ->
    'd_field_eventssidecar.v1.OnClientWakeUp_session_id'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnClientWakeUp'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, _) ->
    #'eventssidecar.v1.OnClientWakeUp'{
...
'dfp_read_field_def_eventssidecar.v1.OnClientWakeUp'(
    ...
    'dg_read_field_def_eventssidecar.v1.OnClientWakeUp'(
        Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
    ).
...
'dg_read_field_def_eventssidecar.v1.OnClientWakeUp'(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_eventssidecar.v1.OnClientWakeUp'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData
                    );
                1 ->
                    'skip_64_eventssidecar.v1.OnClientWakeUp'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData
                    );
                2 ->
                    'skip_length_delimited_eventssidecar.v1.OnClientWakeUp'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData
                    );
                3 ->
                    'skip_group_eventssidecar.v1.OnClientWakeUp'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData
                    );
                5 ->
                    'skip_32_eventssidecar.v1.OnClientWakeUp'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData
                    )
            end
    end;
'dg_read_field_def_eventssidecar.v1.OnClientWakeUp'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, _) ->
    #'eventssidecar.v1.OnClientWakeUp'{
        timestamp = F@_1, client_id = F@_2, mountpoint = F@_3, session_id = F@_4
    }.
...
'skip_group_eventssidecar.v1.OnClientWakeUp'(Bin, _, Z2, FNum, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnClientWakeUp' ->
            'merge_msg_eventssidecar.v1.OnClientWakeUp'(Prev, New, TrUserData);
        'google.protobuf.Timestamp' ->
...
'merge_msg_eventssidecar.v1.OnClientWakeUp'(
    #'eventssidecar.v1.OnClientWakeUp'{
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnClientWakeUp' ->
            'v_msg_eventssidecar.v1.OnClientWakeUp'(Msg, [MsgName], TrUserData);
        'google.protobuf.Timestamp' ->
...
'v_msg_eventssidecar.v1.OnClientWakeUp'(
    #'eventssidecar.v1.OnClientWakeUp'{
        timestamp = F1, client_id = F2, mountpoint = F3, session_id = F4
    },
    Path,
    ...
    ok;
'v_msg_eventssidecar.v1.OnClientWakeUp'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'eventssidecar.v1.OnClientWakeUp'}, X, Path).
