...
'e_mfield_eventssidecar.v1.OnRegister_user_properties'(Msg, Bin, TrUserData) ->
...
'dfp_read_field_def_eventssidecar.v1.OnRegister'(
    <<24, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
) ->
...
'dfp_read_field_def_eventssidecar.v1.OnRegister'(
    ...
    'd_field_eventssidecar.v1.OnRegister_session_id'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnRegister'(
    <<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, R1, F@_8, TrUserData
) ->
    #'eventssidecar.v1.OnRegister'{
        timestamp = F@_1,
        peer_addr = F@_2,
...
'd_field_eventssidecar.v1.OnRegister_user_properties'(
    <<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, Prev, F@_8, TrUserData
) ->
    {NewFValue, RestF} = begin
        Len = X bsl N + Acc,
        <<Bs:Len/binary, Rest2/binary>> = Rest,
