...
%% message types
-type 'eventssidecar.v1.OnRegister'() :: #'eventssidecar.v1.OnRegister'{}.

-type 'google.protobuf.Timestamp'() :: #'google.protobuf.Timestamp'{}.

-export_type(['eventssidecar.v1.OnRegister'/0, 'google.protobuf.Timestamp'/0]).
-type '$msg_name'() :: 'eventssidecar.v1.OnRegister' | 'google.protobuf.Timestamp'.
...
'encode_msg_eventssidecar.v1.OnRegister'(#'eventssidecar.v1.OnRegister'{timestamp = F1, peer_addr = F2, peer_port = F3, username = F4, mountpoint = F5, client_id = F6}, Bin, TrUserData) ->
...
'decode_msg_eventssidecar.v1.OnRegister'(Bin, TrUserData) ->
    'dfp_read_field_def_eventssidecar.v1.OnRegister'(Bin, 0, 0, 0, id(undefined, TrUserData), id(<<>>, TrUserData), id(0, TrUserData), id(<<>>, TrUserData), id(<<>>, TrUserData), id(<<>>, TrUserData), TrUserData).

'dfp_read_field_def_eventssidecar.v1.OnRegister'(<<10, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'd_field_eventssidecar.v1.OnRegister_timestamp'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnRegister'(<<18, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'd_field_eventssidecar.v1.OnRegister_peer_addr'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnRegister'(<<24, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'd_field_eventssidecar.v1.OnRegister_peer_port'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnRegister'(<<34, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'd_field_eventssidecar.v1.OnRegister_username'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnRegister'(<<42, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'd_field_eventssidecar.v1.OnRegister_mountpoint'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnRegister'(<<50, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'd_field_eventssidecar.v1.OnRegister_client_id'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnRegister'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, _) -> #'eventssidecar.v1.OnRegister'{timestamp = F@_1, peer_addr = F@_2, peer_port = F@_3, username = F@_4, mountpoint = F@_5, client_id = F@_6};
'dfp_read_field_def_eventssidecar.v1.OnRegister'(Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'dg_read_field_def_eventssidecar.v1.OnRegister'(Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

'dg_read_field_def_eventssidecar.v1.OnRegister'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 32 - 7 ->
    'dg_read_field_def_eventssidecar.v1.OnRegister'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dg_read_field_def_eventssidecar.v1.OnRegister'(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> 'd_field_eventssidecar.v1.OnRegister_timestamp'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
        18 -> 'd_field_eventssidecar.v1.OnRegister_peer_addr'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
        24 -> 'd_field_eventssidecar.v1.OnRegister_peer_port'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
        34 -> 'd_field_eventssidecar.v1.OnRegister_username'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
        42 -> 'd_field_eventssidecar.v1.OnRegister_mountpoint'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
        50 -> 'd_field_eventssidecar.v1.OnRegister_client_id'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
        _ ->
            case Key band 7 of
                0 -> 'skip_varint_eventssidecar.v1.OnRegister'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
                1 -> 'skip_64_eventssidecar.v1.OnRegister'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
                2 -> 'skip_length_delimited_eventssidecar.v1.OnRegister'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
                3 -> 'skip_group_eventssidecar.v1.OnRegister'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
                5 -> 'skip_32_eventssidecar.v1.OnRegister'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData)
            end
    end;
'dg_read_field_def_eventssidecar.v1.OnRegister'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, _) -> #'eventssidecar.v1.OnRegister'{timestamp = F@_1, peer_addr = F@_2, peer_port = F@_3, username = F@_4, mountpoint = F@_5, client_id = F@_6}.

'd_field_eventssidecar.v1.OnRegister_timestamp'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnRegister_timestamp'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'd_field_eventssidecar.v1.OnRegister_timestamp'(<<0:1, X:7, Rest/binary>>, N, Acc, F, Prev, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
...
'd_field_eventssidecar.v1.OnRegister_peer_addr'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnRegister_peer_addr'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'd_field_eventssidecar.v1.OnRegister_peer_addr'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, _, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_eventssidecar.v1.OnRegister'(RestF, 0, 0, F, F@_1, NewFValue, F@_3, F@_4, F@_5, F@_6, TrUserData).

'd_field_eventssidecar.v1.OnRegister_peer_port'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnRegister_peer_port'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'd_field_eventssidecar.v1.OnRegister_peer_port'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, _, F@_4, F@_5, F@_6, TrUserData) ->
    {NewFValue, RestF} = {begin <<Res:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>, id(Res, TrUserData) end, Rest},
    'dfp_read_field_def_eventssidecar.v1.OnRegister'(RestF, 0, 0, F, F@_1, F@_2, NewFValue, F@_4, F@_5, F@_6, TrUserData).

'd_field_eventssidecar.v1.OnRegister_username'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnRegister_username'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'd_field_eventssidecar.v1.OnRegister_username'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, _, F@_5, F@_6, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_eventssidecar.v1.OnRegister'(RestF, 0, 0, F, F@_1, F@_2, F@_3, NewFValue, F@_5, F@_6, TrUserData).

'd_field_eventssidecar.v1.OnRegister_mountpoint'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnRegister_mountpoint'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'd_field_eventssidecar.v1.OnRegister_mountpoint'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, _, F@_6, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_eventssidecar.v1.OnRegister'(RestF, 0, 0, F, F@_1, F@_2, F@_3, F@_4, NewFValue, F@_6, TrUserData).

'd_field_eventssidecar.v1.OnRegister_client_id'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnRegister_client_id'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'd_field_eventssidecar.v1.OnRegister_client_id'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, _, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_eventssidecar.v1.OnRegister'(RestF, 0, 0, F, F@_1, F@_2, F@_3, F@_4, F@_5, NewFValue, TrUserData).

'skip_varint_eventssidecar.v1.OnRegister'(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'skip_varint_eventssidecar.v1.OnRegister'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'skip_varint_eventssidecar.v1.OnRegister'(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnRegister'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

'skip_length_delimited_eventssidecar.v1.OnRegister'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) when N < 57 ->
    'skip_length_delimited_eventssidecar.v1.OnRegister'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'skip_length_delimited_eventssidecar.v1.OnRegister'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_eventssidecar.v1.OnRegister'(Rest2, 0, 0, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

'skip_group_eventssidecar.v1.OnRegister'(Bin, _, Z2, FNum, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_eventssidecar.v1.OnRegister'(Rest, 0, Z2, FNum, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

'skip_32_eventssidecar.v1.OnRegister'(<<_:32, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnRegister'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).

'skip_64_eventssidecar.v1.OnRegister'(<<_:64, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnRegister'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData).
...
'merge_msg_eventssidecar.v1.OnRegister'(#'eventssidecar.v1.OnRegister'{timestamp = PFtimestamp, peer_addr = PFpeer_addr, peer_port = PFpeer_port, username = PFusername, mountpoint = PFmountpoint, client_id = PFclient_id},
                                        #'eventssidecar.v1.OnRegister'{timestamp = NFtimestamp, peer_addr = NFpeer_addr, peer_port = NFpeer_port, username = NFusername, mountpoint = NFmountpoint, client_id = NFclient_id}, TrUserData) ->
...
'v_msg_eventssidecar.v1.OnRegister'(#'eventssidecar.v1.OnRegister'{timestamp = F1, peer_addr = F2, peer_port = F3, username = F4, mountpoint = F5, client_id = F6}, Path, TrUserData) ->
    if F1 == undefined -> ok;
