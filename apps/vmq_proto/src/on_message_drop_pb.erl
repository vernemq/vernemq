...
-include("on_message_drop_pb.hrl").
-include("gpb.hrl").
...
%% message types
-type 'eventssidecar.v1.OnMessageDrop'() :: #'eventssidecar.v1.OnMessageDrop'{}.
...
-export_type([
    'eventssidecar.v1.OnMessageDrop'/0,
    'google.protobuf.Timestamp'/0,
    'eventssidecar.v1.MatchedACL'/0
]).
-type '$msg_name'() ::
    'eventssidecar.v1.OnMessageDrop' | 'google.protobuf.Timestamp' | 'eventssidecar.v1.MatchedACL'.
-type '$msg'() ::
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnMessageDrop' ->
            'encode_msg_eventssidecar.v1.OnMessageDrop'(id(Msg, TrUserData), TrUserData);
        'google.protobuf.Timestamp' ->
...
'encode_msg_eventssidecar.v1.OnMessageDrop'(Msg, TrUserData) ->
    'encode_msg_eventssidecar.v1.OnMessageDrop'(Msg, <<>>, TrUserData).

'encode_msg_eventssidecar.v1.OnMessageDrop'(
    #'eventssidecar.v1.OnMessageDrop'{
        timestamp = F1,
        client_id = F2,
        mountpoint = F3,
                ...
                begin
                    ...
                    if
                        TrF1 =:= undefined ->
                            Bin;
                        true ->
                            'e_mfield_eventssidecar.v1.OnMessageDrop_timestamp'(
...
decode_msg_2_doit('eventssidecar.v1.OnMessageDrop', Bin, TrUserData) ->
    id('decode_msg_eventssidecar.v1.OnMessageDrop'(Bin, TrUserData), TrUserData);
...
'decode_msg_eventssidecar.v1.OnMessageDrop'(Bin, TrUserData) ->
...
'dfp_read_field_def_eventssidecar.v1.OnMessageDrop'(
    <<32, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
) ->
...
'dfp_read_field_def_eventssidecar.v1.OnMessageDrop'(
    <<50, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
) ->
    'd_field_eventssidecar.v1.OnMessageDrop_payload'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnMessageDrop'(
    <<58, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
) ->
...
'dfp_read_field_def_eventssidecar.v1.OnMessageDrop'(
    ...
    'd_field_eventssidecar.v1.OnMessageDrop_session_id'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnMessageDrop'(
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnMessageDrop' ->
            'merge_msg_eventssidecar.v1.OnMessageDrop'(Prev, New, TrUserData);
        'google.protobuf.Timestamp' ->
...
-compile({nowarn_unused_function, 'merge_msg_eventssidecar.v1.OnMessageDrop'/3}).
'merge_msg_eventssidecar.v1.OnMessageDrop'(
    #'eventssidecar.v1.OnMessageDrop'{
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnMessageDrop' ->
            'v_msg_eventssidecar.v1.OnMessageDrop'(Msg, [MsgName], TrUserData);
        'google.protobuf.Timestamp' ->
...
-compile({nowarn_unused_function, 'v_msg_eventssidecar.v1.OnMessageDrop'/3}).
-dialyzer({nowarn_function, 'v_msg_eventssidecar.v1.OnMessageDrop'/3}).
'v_msg_eventssidecar.v1.OnMessageDrop'(
    #'eventssidecar.v1.OnMessageDrop'{
        timestamp = F1,
        client_id = F2,
        mountpoint = F3,
    ...
    if
        F9 == undefined -> ok;
        true -> v_type_string(F9, [session_id | Path], TrUserData)
    end,
    ok;
...
get_msg_defs() ->
    [
        {{msg, 'eventssidecar.v1.OnMessageDrop'}, [
            #field{
                name = timestamp,
                fnum = 1,
                rnum = 2,
...
find_msg_def('eventssidecar.v1.OnMessageDrop') ->
    [
        #field{
            name = timestamp,
            fnum = 1,
        ...
        #field{
            name = session_id, fnum = 9, rnum = 10, type = string, occurrence = optional, opts = []
        }
    ];
...
fqbin_to_msg_name(<<"eventssidecar.v1.OnMessageDrop">>) -> 'eventssidecar.v1.OnMessageDrop';
...
msg_name_to_fqbin('eventssidecar.v1.OnMessageDrop') -> <<"eventssidecar.v1.OnMessageDrop">>;
...
source_basename() -> "on_message_drop.proto".
...
get_all_source_basenames() -> ["on_message_drop.proto", "timestamp.proto", "matched_acl.proto"].
...
%% functions.
get_all_proto_names() -> ["on_message_drop", "timestamp", "matched_acl"].

get_msg_containment("on_message_drop") -> ['eventssidecar.v1.OnMessageDrop'];
...
get_proto_by_msg_name_as_fqbin(<<"eventssidecar.v1.OnMessageDrop">>) -> "on_message_drop";
...
get_protos_by_pkg_name_as_fqbin(<<"eventssidecar.v1">>) -> ["matched_acl", "on_message_drop"];
