...
source_basename() -> "matched_acl.proto".
...
get_all_source_basenames() -> ["matched_acl.proto"].
...
get_protos_by_pkg_name_as_fqbin(<<"eventssidecar.v1">>) -> ["matched_acl"];
