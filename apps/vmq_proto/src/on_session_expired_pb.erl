...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnSessionExpired' ->
            'encode_msg_eventssidecar.v1.OnSessionExpired'(id(Msg, TrUserData), TrUserData);
        'google.protobuf.Timestamp' ->
            'encode_msg_google.protobuf.Timestamp'(id(Msg, TrUserData), TrUserData)
    end.

'encode_msg_eventssidecar.v1.OnSessionExpired'(Msg, TrUserData) ->
    'encode_msg_eventssidecar.v1.OnSessionExpired'(Msg, <<>>, TrUserData).

'encode_msg_eventssidecar.v1.OnSessionExpired'(
    #'eventssidecar.v1.OnSessionExpired'{
        timestamp = F1, client_id = F2, mountpoint = F3, session_id = F4
    },
    Bin,
    TrUserData
) ->
                ...
                begin
                    ...
                    if
                        TrF1 =:= undefined ->
                            Bin;
                        true ->
                            'e_mfield_eventssidecar.v1.OnSessionExpired_timestamp'(
...
decode_msg_2_doit('eventssidecar.v1.OnSessionExpired', Bin, TrUserData) ->
    id('decode_msg_eventssidecar.v1.OnSessionExpired'(Bin, TrUserData), TrUserData);
...
'decode_msg_eventssidecar.v1.OnSessionExpired'(Bin, TrUserData) ->
    'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(
        Bin,
        0,
        0,
        0,
...
'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(
    ...
    'd_field_eventssidecar.v1.OnSessionExpired_timestamp'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(
    <<18, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
) ->
    'd_field_eventssidecar.v1.OnSessionExpired_client_id'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(
    <<26, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
) ->
    'd_field_eventssidecar.v1.OnSessionExpired_mountpoint'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(
    <<34, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
) ->
    'd_field_eventssidecar.v1.OnSessionExpired_session_id'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, _) ->
    #'eventssidecar.v1.OnSessionExpired'{
        timestamp = F@_1, client_id = F@_2, mountpoint = F@_3, session_id = F@_4
    };
'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(
    Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
) ->
    'dg_read_field_def_eventssidecar.v1.OnSessionExpired'(
        Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, TrUserData
    ).
...
'dg_read_field_def_eventssidecar.v1.OnSessionExpired'(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_eventssidecar.v1.OnSessionExpired'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData
                    );
                1 ->
                    'skip_64_eventssidecar.v1.OnSessionExpired'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData
                    );
                2 ->
                    'skip_length_delimited_eventssidecar.v1.OnSessionExpired'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData
                    );
                3 ->
                    'skip_group_eventssidecar.v1.OnSessionExpired'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData
                    );
                5 ->
                    'skip_32_eventssidecar.v1.OnSessionExpired'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, TrUserData
                    )
            end
    end;
'dg_read_field_def_eventssidecar.v1.OnSessionExpired'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, _) ->
    #'eventssidecar.v1.OnSessionExpired'{
        timestamp = F@_1, client_id = F@_2, mountpoint = F@_3, session_id = F@_4
    }.
...
'skip_group_eventssidecar.v1.OnSessionExpired'(
    Bin, _, Z2, FNum, F@_1, F@_2, F@_3, F@_4, TrUserData
) ->
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnSessionExpired' ->
            'merge_msg_eventssidecar.v1.OnSessionExpired'(Prev, New, TrUserData);
        'google.protobuf.Timestamp' ->
...
'merge_msg_eventssidecar.v1.OnSessionExpired'(
    #'eventssidecar.v1.OnSessionExpired'{
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnSessionExpired' ->
            'v_msg_eventssidecar.v1.OnSessionExpired'(Msg, [MsgName], TrUserData);
        'google.protobuf.Timestamp' ->
...
'v_msg_eventssidecar.v1.OnSessionExpired'(
    #'eventssidecar.v1.OnSessionExpired'{
        timestamp = F1, client_id = F2, mountpoint = F3, session_id = F4
    },
    Path,
    ...
    if
        F4 == undefined -> ok;
        true -> v_type_string(F4, [session_id | Path], TrUserData)
    end,
    ok;
'v_msg_eventssidecar.v1.OnSessionExpired'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'eventssidecar.v1.OnSessionExpired'}, X, Path).
...
find_msg_def('eventssidecar.v1.OnSessionExpired') ->
    [
        ...
        #field{
            name = session_id, fnum = 4, rnum = 5, type = string, occurrence = optional, opts = []
        }
    ];
