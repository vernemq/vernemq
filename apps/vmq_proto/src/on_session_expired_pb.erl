...
'encode_msg_eventssidecar.v1.OnSessionExpired'(
    #'eventssidecar.v1.OnSessionExpired'{timestamp = F1, client_id = F2, mountpoint = F3},
    Bin,
    TrUserData
) ->
    B1 =
...
'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(
    <<18, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData
) ->
...
'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, _) ->
    #'eventssidecar.v1.OnSessionExpired'{timestamp = F@_1, client_id = F@_2, mountpoint = F@_3};
'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(
    Other, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData
) ->
...
'dg_read_field_def_eventssidecar.v1.OnSessionExpired'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, _) ->
    #'eventssidecar.v1.OnSessionExpired'{timestamp = F@_1, client_id = F@_2, mountpoint = F@_3}.
...
'd_field_eventssidecar.v1.OnSessionExpired_timestamp'(
    <<0:1, X:7, Rest/binary>>, N, Acc, F, Prev, F@_2, F@_3, TrUserData
) ->
...
'd_field_eventssidecar.v1.OnSessionExpired_mountpoint'(
    <<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, _, TrUserData
) ->
    {NewFValue, RestF} = begin
        Len = X bsl N + Acc,
        <<Bytes:Len/binary, Rest2/binary>> = Rest,
    ...
    'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(
        RestF, 0, 0, F, F@_1, F@_2, NewFValue, TrUserData
    ).

'skip_varint_eventssidecar.v1.OnSessionExpired'(
    <<1:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData
) ->
    'skip_varint_eventssidecar.v1.OnSessionExpired'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
'skip_varint_eventssidecar.v1.OnSessionExpired'(
...
'skip_length_delimited_eventssidecar.v1.OnSessionExpired'(
    ...
    'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(
        Rest2, 0, 0, F, F@_1, F@_2, F@_3, TrUserData
    ).
...
'merge_msg_eventssidecar.v1.OnSessionExpired'(
    #'eventssidecar.v1.OnSessionExpired'{
        timestamp = PFtimestamp, client_id = PFclient_id, mountpoint = PFmountpoint
    },
    #'eventssidecar.v1.OnSessionExpired'{
        timestamp = NFtimestamp, client_id = NFclient_id, mountpoint = NFmountpoint
    },
    TrUserData
) ->
    #'eventssidecar.v1.OnSessionExpired'{
