...
-include("on_session_expired_pb.hrl").
-include("gpb.hrl").
...
%% message types
-type 'eventssidecar.v1.OnSessionExpired'() :: #'eventssidecar.v1.OnSessionExpired'{}.

-type 'google.protobuf.Timestamp'() :: #'google.protobuf.Timestamp'{}.

-export_type(['eventssidecar.v1.OnSessionExpired'/0, 'google.protobuf.Timestamp'/0]).
-type '$msg_name'() :: 'eventssidecar.v1.OnSessionExpired' | 'google.protobuf.Timestamp'.
-type '$msg'() :: 'eventssidecar.v1.OnSessionExpired'() | 'google.protobuf.Timestamp'().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnSessionExpired' -> 'encode_msg_eventssidecar.v1.OnSessionExpired'(id(Msg, TrUserData), TrUserData);
        'google.protobuf.Timestamp' -> 'encode_msg_google.protobuf.Timestamp'(id(Msg, TrUserData), TrUserData)
    end.


'encode_msg_eventssidecar.v1.OnSessionExpired'(Msg, TrUserData) -> 'encode_msg_eventssidecar.v1.OnSessionExpired'(Msg, <<>>, TrUserData).


'encode_msg_eventssidecar.v1.OnSessionExpired'(#'eventssidecar.v1.OnSessionExpired'{timestamp = F1, client_id = F2, mountpoint = F3}, Bin, TrUserData) ->
    B1 = if F1 == undefined -> Bin;
            true ->
                begin
                    TrF1 = id(F1, TrUserData),
                    if TrF1 =:= undefined -> Bin;
                       true -> 'e_mfield_eventssidecar.v1.OnSessionExpired_timestamp'(TrF1, <<Bin/binary, 10>>, TrUserData)
                    end
                end
         end,
...
'e_mfield_eventssidecar.v1.OnSessionExpired_timestamp'(Msg, Bin, TrUserData) ->
...
decode_msg_2_doit('eventssidecar.v1.OnSessionExpired', Bin, TrUserData) -> id('decode_msg_eventssidecar.v1.OnSessionExpired'(Bin, TrUserData), TrUserData);
...
'decode_msg_eventssidecar.v1.OnSessionExpired'(Bin, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(Bin, 0, 0, 0, id(undefined, TrUserData), id(<<>>, TrUserData), id(<<>>, TrUserData), TrUserData).

'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(<<10, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'd_field_eventssidecar.v1.OnSessionExpired_timestamp'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(<<18, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'd_field_eventssidecar.v1.OnSessionExpired_client_id'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(<<26, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'd_field_eventssidecar.v1.OnSessionExpired_mountpoint'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, _) -> #'eventssidecar.v1.OnSessionExpired'{timestamp = F@_1, client_id = F@_2, mountpoint = F@_3};
'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(Other, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'dg_read_field_def_eventssidecar.v1.OnSessionExpired'(Other, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData).

'dg_read_field_def_eventssidecar.v1.OnSessionExpired'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 32 - 7 ->
    'dg_read_field_def_eventssidecar.v1.OnSessionExpired'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
'dg_read_field_def_eventssidecar.v1.OnSessionExpired'(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, F@_2, F@_3, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> 'd_field_eventssidecar.v1.OnSessionExpired_timestamp'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, TrUserData);
        18 -> 'd_field_eventssidecar.v1.OnSessionExpired_client_id'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, TrUserData);
        26 -> 'd_field_eventssidecar.v1.OnSessionExpired_mountpoint'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, TrUserData);
        _ ->
            case Key band 7 of
                0 -> 'skip_varint_eventssidecar.v1.OnSessionExpired'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData);
                1 -> 'skip_64_eventssidecar.v1.OnSessionExpired'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData);
                2 -> 'skip_length_delimited_eventssidecar.v1.OnSessionExpired'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData);
                3 -> 'skip_group_eventssidecar.v1.OnSessionExpired'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData);
                5 -> 'skip_32_eventssidecar.v1.OnSessionExpired'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData)
            end
    end;
'dg_read_field_def_eventssidecar.v1.OnSessionExpired'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, _) -> #'eventssidecar.v1.OnSessionExpired'{timestamp = F@_1, client_id = F@_2, mountpoint = F@_3}.

'd_field_eventssidecar.v1.OnSessionExpired_timestamp'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnSessionExpired_timestamp'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
'd_field_eventssidecar.v1.OnSessionExpired_timestamp'(<<0:1, X:7, Rest/binary>>, N, Acc, F, Prev, F@_2, F@_3, TrUserData) ->
    ...
    'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(RestF,
                                                           0,
                                                           0,
                                                           F,
...
'd_field_eventssidecar.v1.OnSessionExpired_client_id'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnSessionExpired_client_id'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
'd_field_eventssidecar.v1.OnSessionExpired_client_id'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, _, F@_3, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(RestF, 0, 0, F, F@_1, NewFValue, F@_3, TrUserData).

'd_field_eventssidecar.v1.OnSessionExpired_mountpoint'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnSessionExpired_mountpoint'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
'd_field_eventssidecar.v1.OnSessionExpired_mountpoint'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, _, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(RestF, 0, 0, F, F@_1, F@_2, NewFValue, TrUserData).

'skip_varint_eventssidecar.v1.OnSessionExpired'(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'skip_varint_eventssidecar.v1.OnSessionExpired'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
'skip_varint_eventssidecar.v1.OnSessionExpired'(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData).

'skip_length_delimited_eventssidecar.v1.OnSessionExpired'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 57 ->
    'skip_length_delimited_eventssidecar.v1.OnSessionExpired'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
'skip_length_delimited_eventssidecar.v1.OnSessionExpired'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(Rest2, 0, 0, F, F@_1, F@_2, F@_3, TrUserData).

'skip_group_eventssidecar.v1.OnSessionExpired'(Bin, _, Z2, FNum, F@_1, F@_2, F@_3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(Rest, 0, Z2, FNum, F@_1, F@_2, F@_3, TrUserData).

'skip_32_eventssidecar.v1.OnSessionExpired'(<<_:32, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData).

'skip_64_eventssidecar.v1.OnSessionExpired'(<<_:64, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnSessionExpired'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    TrUserData = proplists:get_value(user_data, Opts),
    case MsgName of
        'eventssidecar.v1.OnSessionExpired' -> 'merge_msg_eventssidecar.v1.OnSessionExpired'(Prev, New, TrUserData);
        'google.protobuf.Timestamp' -> 'merge_msg_google.protobuf.Timestamp'(Prev, New, TrUserData)
    end.

-compile({nowarn_unused_function,'merge_msg_eventssidecar.v1.OnSessionExpired'/3}).
'merge_msg_eventssidecar.v1.OnSessionExpired'(#'eventssidecar.v1.OnSessionExpired'{timestamp = PFtimestamp, client_id = PFclient_id, mountpoint = PFmountpoint},
                                              #'eventssidecar.v1.OnSessionExpired'{timestamp = NFtimestamp, client_id = NFclient_id, mountpoint = NFmountpoint}, TrUserData) ->
    #'eventssidecar.v1.OnSessionExpired'{timestamp =
...
verify_msg(Msg, MsgName, Opts) ->
    TrUserData = proplists:get_value(user_data, Opts),
    case MsgName of
        'eventssidecar.v1.OnSessionExpired' -> 'v_msg_eventssidecar.v1.OnSessionExpired'(Msg, [MsgName], TrUserData);
        'google.protobuf.Timestamp' -> 'v_msg_google.protobuf.Timestamp'(Msg, [MsgName], TrUserData);
        _ -> mk_type_error(not_a_known_message, Msg, [])
    end.


-compile({nowarn_unused_function,'v_msg_eventssidecar.v1.OnSessionExpired'/3}).
-dialyzer({nowarn_function,'v_msg_eventssidecar.v1.OnSessionExpired'/3}).
'v_msg_eventssidecar.v1.OnSessionExpired'(#'eventssidecar.v1.OnSessionExpired'{timestamp = F1, client_id = F2, mountpoint = F3}, Path, TrUserData) ->
    if F1 == undefined -> ok;
    ...
    ok;
'v_msg_eventssidecar.v1.OnSessionExpired'(X, Path, _TrUserData) -> mk_type_error({expected_msg, 'eventssidecar.v1.OnSessionExpired'}, X, Path).
...
get_msg_defs() ->
    [{{msg, 'eventssidecar.v1.OnSessionExpired'},
...
get_msg_names() -> ['eventssidecar.v1.OnSessionExpired', 'google.protobuf.Timestamp'].


get_group_names() -> [].


get_msg_or_group_names() -> ['eventssidecar.v1.OnSessionExpired', 'google.protobuf.Timestamp'].
...
find_msg_def('eventssidecar.v1.OnSessionExpired') ->
    [#field{name = timestamp, fnum = 1, rnum = 2, type = {msg, 'google.protobuf.Timestamp'}, occurrence = optional, opts = []},
     #field{name = client_id, fnum = 2, rnum = 3, type = string, occurrence = optional, opts = []},
     #field{name = mountpoint, fnum = 3, rnum = 4, type = string, occurrence = optional, opts = []}];
...
fqbin_to_msg_name(<<"eventssidecar.v1.OnSessionExpired">>) -> 'eventssidecar.v1.OnSessionExpired';
fqbin_to_msg_name(<<"google.protobuf.Timestamp">>) -> 'google.protobuf.Timestamp';
fqbin_to_msg_name(E) -> error({gpb_error, {badmsg, E}}).


msg_name_to_fqbin('eventssidecar.v1.OnSessionExpired') -> <<"eventssidecar.v1.OnSessionExpired">>;
...
source_basename() -> "on_session_expired.proto".
...
get_all_source_basenames() -> ["on_session_expired.proto", "timestamp.proto"].
...
%% functions.
get_all_proto_names() -> ["on_session_expired", "timestamp"].


get_msg_containment("on_session_expired") -> ['eventssidecar.v1.OnSessionExpired'];
get_msg_containment("timestamp") -> ['google.protobuf.Timestamp'];
get_msg_containment(P) -> error({gpb_error, {badproto, P}}).


get_pkg_containment("on_session_expired") -> 'eventssidecar.v1';
get_pkg_containment("timestamp") -> 'google.protobuf';
get_pkg_containment(P) -> error({gpb_error, {badproto, P}}).


get_service_containment("on_session_expired") -> [];
get_service_containment("timestamp") -> [];
get_service_containment(P) -> error({gpb_error, {badproto, P}}).


get_rpc_containment("on_session_expired") -> [];
get_rpc_containment("timestamp") -> [];
get_rpc_containment(P) -> error({gpb_error, {badproto, P}}).


get_enum_containment("on_session_expired") -> [];
get_enum_containment("timestamp") -> [];
get_enum_containment(P) -> error({gpb_error, {badproto, P}}).


get_proto_by_msg_name_as_fqbin(<<"google.protobuf.Timestamp">>) -> "timestamp";
get_proto_by_msg_name_as_fqbin(<<"eventssidecar.v1.OnSessionExpired">>) -> "on_session_expired";
...
get_protos_by_pkg_name_as_fqbin(<<"eventssidecar.v1">>) -> ["on_session_expired"];
