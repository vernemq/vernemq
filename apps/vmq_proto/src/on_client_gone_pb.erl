...
'encode_msg_eventssidecar.v1.OnClientGone'(#'eventssidecar.v1.OnClientGone'{timestamp = F1, client_id = F2, mountpoint = F3}, Bin, TrUserData) ->
...
'decode_msg_eventssidecar.v1.OnClientGone'(Bin, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Bin, 0, 0, 0, id(undefined, TrUserData), id(<<>>, TrUserData), id(<<>>, TrUserData), TrUserData).

'dfp_read_field_def_eventssidecar.v1.OnClientGone'(<<10, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'd_field_eventssidecar.v1.OnClientGone_timestamp'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(<<18, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'd_field_eventssidecar.v1.OnClientGone_client_id'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(<<26, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'd_field_eventssidecar.v1.OnClientGone_mountpoint'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, _) -> #'eventssidecar.v1.OnClientGone'{timestamp = F@_1, client_id = F@_2, mountpoint = F@_3};
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Other, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'dg_read_field_def_eventssidecar.v1.OnClientGone'(Other, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData).

'dg_read_field_def_eventssidecar.v1.OnClientGone'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 32 - 7 -> 'dg_read_field_def_eventssidecar.v1.OnClientGone'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
'dg_read_field_def_eventssidecar.v1.OnClientGone'(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, F@_2, F@_3, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> 'd_field_eventssidecar.v1.OnClientGone_timestamp'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, TrUserData);
        18 -> 'd_field_eventssidecar.v1.OnClientGone_client_id'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, TrUserData);
        26 -> 'd_field_eventssidecar.v1.OnClientGone_mountpoint'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, TrUserData);
        _ ->
            case Key band 7 of
                0 -> 'skip_varint_eventssidecar.v1.OnClientGone'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData);
                1 -> 'skip_64_eventssidecar.v1.OnClientGone'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData);
                2 -> 'skip_length_delimited_eventssidecar.v1.OnClientGone'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData);
                3 -> 'skip_group_eventssidecar.v1.OnClientGone'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData);
                5 -> 'skip_32_eventssidecar.v1.OnClientGone'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, TrUserData)
            end
    end;
'dg_read_field_def_eventssidecar.v1.OnClientGone'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, _) -> #'eventssidecar.v1.OnClientGone'{timestamp = F@_1, client_id = F@_2, mountpoint = F@_3}.

'd_field_eventssidecar.v1.OnClientGone_timestamp'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 57 -> 'd_field_eventssidecar.v1.OnClientGone_timestamp'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
'd_field_eventssidecar.v1.OnClientGone_timestamp'(<<0:1, X:7, Rest/binary>>, N, Acc, F, Prev, F@_2, F@_3, TrUserData) ->
...
'd_field_eventssidecar.v1.OnClientGone_client_id'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 57 -> 'd_field_eventssidecar.v1.OnClientGone_client_id'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
'd_field_eventssidecar.v1.OnClientGone_client_id'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, _, F@_3, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_eventssidecar.v1.OnClientGone'(RestF, 0, 0, F, F@_1, NewFValue, F@_3, TrUserData).

'd_field_eventssidecar.v1.OnClientGone_mountpoint'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 57 -> 'd_field_eventssidecar.v1.OnClientGone_mountpoint'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
'd_field_eventssidecar.v1.OnClientGone_mountpoint'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, _, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_eventssidecar.v1.OnClientGone'(RestF, 0, 0, F, F@_1, F@_2, NewFValue, TrUserData).

'skip_varint_eventssidecar.v1.OnClientGone'(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'skip_varint_eventssidecar.v1.OnClientGone'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
'skip_varint_eventssidecar.v1.OnClientGone'(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData).

'skip_length_delimited_eventssidecar.v1.OnClientGone'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) when N < 57 ->
    'skip_length_delimited_eventssidecar.v1.OnClientGone'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, TrUserData);
'skip_length_delimited_eventssidecar.v1.OnClientGone'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Rest2, 0, 0, F, F@_1, F@_2, F@_3, TrUserData).

'skip_group_eventssidecar.v1.OnClientGone'(Bin, _, Z2, FNum, F@_1, F@_2, F@_3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Rest, 0, Z2, FNum, F@_1, F@_2, F@_3, TrUserData).

'skip_32_eventssidecar.v1.OnClientGone'(<<_:32, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData).

'skip_64_eventssidecar.v1.OnClientGone'(<<_:64, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData).
...
'merge_msg_eventssidecar.v1.OnClientGone'(#'eventssidecar.v1.OnClientGone'{timestamp = PFtimestamp, client_id = PFclient_id, mountpoint = PFmountpoint},
                                          #'eventssidecar.v1.OnClientGone'{timestamp = NFtimestamp, client_id = NFclient_id, mountpoint = NFmountpoint}, TrUserData) ->
...
'v_msg_eventssidecar.v1.OnClientGone'(#'eventssidecar.v1.OnClientGone'{timestamp = F1, client_id = F2, mountpoint = F3}, Path, TrUserData) ->
    if F1 == undefined -> ok;
...
get_all_source_basenames() -> ["on_client_gone.proto", "timestamp.proto"].
...
%% functions.
get_all_proto_names() -> ["on_client_gone", "timestamp"].
...
get_protos_by_pkg_name_as_fqbin(<<"eventssidecar.v1">>) -> ["on_client_gone"];
