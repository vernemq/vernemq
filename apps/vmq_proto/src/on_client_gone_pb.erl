...
'encode_msg_eventssidecar.v1.OnClientGone'(
    #'eventssidecar.v1.OnClientGone'{timestamp = F1, client_id = F2, mountpoint = F3, reason = F4},
    Bin,
    TrUserData
) ->
    B1 =
...
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, _) ->
    #'eventssidecar.v1.OnClientGone'{
...
'dg_read_field_def_eventssidecar.v1.OnClientGone'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, _) ->
    #'eventssidecar.v1.OnClientGone'{
        timestamp = F@_1, client_id = F@_2, mountpoint = F@_3, reason = F@_4
    }.
...
'skip_group_eventssidecar.v1.OnClientGone'(Bin, _, Z2, FNum, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
