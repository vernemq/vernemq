...
'encode_msg_eventssidecar.v1.OnClientGone'(
    #'eventssidecar.v1.OnClientGone'{timestamp = F1, client_id = F2, mountpoint = F3},
    Bin,
    TrUserData
) ->
    B1 =
...
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, _) ->
    #'eventssidecar.v1.OnClientGone'{timestamp = F@_1, client_id = F@_2, mountpoint = F@_3};
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Other, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData) ->
...
'dg_read_field_def_eventssidecar.v1.OnClientGone'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, _) ->
    #'eventssidecar.v1.OnClientGone'{timestamp = F@_1, client_id = F@_2, mountpoint = F@_3}.
...
'skip_varint_eventssidecar.v1.OnClientGone'(
    ...
    'skip_varint_eventssidecar.v1.OnClientGone'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, TrUserData);
'skip_varint_eventssidecar.v1.OnClientGone'(
