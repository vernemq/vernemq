...
-export_type([
    'eventssidecar.v1.OnPublish'/0, 'google.protobuf.Timestamp'/0, 'eventssidecar.v1.MatchedACL'/0
]).
-type '$msg_name'() ::
    'eventssidecar.v1.OnPublish' | 'google.protobuf.Timestamp' | 'eventssidecar.v1.MatchedACL'.
-type '$msg'() ::
...
'encode_msg_eventssidecar.v1.OnPublish'(Msg, TrUserData) ->
    'encode_msg_eventssidecar.v1.OnPublish'(Msg, <<>>, TrUserData).

'encode_msg_eventssidecar.v1.OnPublish'(
    #'eventssidecar.v1.OnPublish'{
        timestamp = F1,
        username = F2,
        client_id = F3,
                ...
                begin
                    ...
                    if
                        TrF1 =:= undefined ->
                            Bin;
                        true ->
                            'e_mfield_eventssidecar.v1.OnPublish_timestamp'(
            ...
            begin
                ...
                if
                    TrF9 =:= undefined ->
                        B8;
                    true ->
                        'e_mfield_eventssidecar.v1.OnPublish_matched_acl'(
...
'dfp_read_field_def_eventssidecar.v1.OnPublish'(
    ...
    'd_field_eventssidecar.v1.OnPublish_username'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnPublish'(
    <<26, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
) ->
    'd_field_eventssidecar.v1.OnPublish_client_id'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnPublish'(
    <<34, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
) ->
    'd_field_eventssidecar.v1.OnPublish_mountpoint'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnPublish'(
    <<40, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
) ->
    'd_field_eventssidecar.v1.OnPublish_qos'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnPublish'(
    <<50, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
) ->
    'd_field_eventssidecar.v1.OnPublish_topic'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnPublish'(
    <<58, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
) ->
    'd_field_eventssidecar.v1.OnPublish_payload'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnPublish'(
    <<64, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
) ->
    'd_field_eventssidecar.v1.OnPublish_retain'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnPublish'(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                1 ->
                    'skip_64_eventssidecar.v1.OnPublish'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                2 ->
                    'skip_length_delimited_eventssidecar.v1.OnPublish'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                3 ->
                    'skip_group_eventssidecar.v1.OnPublish'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                5 ->
                    'skip_32_eventssidecar.v1.OnPublish'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
...
'merge_msg_eventssidecar.v1.OnPublish'(
    #'eventssidecar.v1.OnPublish'{
...
'v_msg_eventssidecar.v1.OnPublish'(
    #'eventssidecar.v1.OnPublish'{
        timestamp = F1,
        username = F2,
        client_id = F3,
...
get_msg_defs() ->
    [
        {{msg, 'eventssidecar.v1.OnPublish'}, [
            ...
            #field{
                name = topic, fnum = 6, rnum = 7, type = string, occurrence = optional, opts = []
            },
            #field{
                name = payload, fnum = 7, rnum = 8, type = bytes, occurrence = optional, opts = []
            },
            #field{
...
get_all_source_basenames() -> ["on_publish.proto", "timestamp.proto", "matched_acl.proto"].
...
%% functions.
get_all_proto_names() -> ["on_publish", "timestamp", "matched_acl"].
...
get_protos_by_pkg_name_as_fqbin(<<"eventssidecar.v1">>) -> ["matched_acl", "on_publish"];
