...
-export_type([
    'eventssidecar.v1.OnDeliveryComplete'/0,
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnDeliveryComplete' ->
            'encode_msg_eventssidecar.v1.OnDeliveryComplete'(id(Msg, TrUserData), TrUserData);
        'google.protobuf.Timestamp' ->
...
'encode_msg_eventssidecar.v1.OnDeliveryComplete'(Msg, TrUserData) ->
    'encode_msg_eventssidecar.v1.OnDeliveryComplete'(Msg, <<>>, TrUserData).

'encode_msg_eventssidecar.v1.OnDeliveryComplete'(
    #'eventssidecar.v1.OnDeliveryComplete'{
        timestamp = F1,
        username = F2,
        client_id = F3,
                ...
                begin
                    ...
                    if
                        TrF1 =:= undefined ->
                            Bin;
                        true ->
                            'e_mfield_eventssidecar.v1.OnDeliveryComplete_timestamp'(
...
'e_mfield_eventssidecar.v1.OnDeliveryComplete_matched_acl'(Msg, Bin, TrUserData) ->
...
decode_msg_2_doit('eventssidecar.v1.OnDeliveryComplete', Bin, TrUserData) ->
    id('decode_msg_eventssidecar.v1.OnDeliveryComplete'(Bin, TrUserData), TrUserData);
...
'dfp_read_field_def_eventssidecar.v1.OnDeliveryComplete'(
    ...
    'd_field_eventssidecar.v1.OnDeliveryComplete_session_id'(
        Rest,
        Z1,
        Z2,
        F,
...
'dfp_read_field_def_eventssidecar.v1.OnDeliveryComplete'(
    <<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, _
) ->
    #'eventssidecar.v1.OnDeliveryComplete'{
        timestamp = F@_1,
        username = F@_2,
...
'dfp_read_field_def_eventssidecar.v1.OnDeliveryComplete'(
    Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, TrUserData
) ->
...
'skip_group_eventssidecar.v1.OnDeliveryComplete'(
    Bin, _, Z2, FNum, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, TrUserData
) ->
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnDeliveryComplete' ->
            'merge_msg_eventssidecar.v1.OnDeliveryComplete'(Prev, New, TrUserData);
        'google.protobuf.Timestamp' ->
...
'merge_msg_eventssidecar.v1.OnDeliveryComplete'(
    #'eventssidecar.v1.OnDeliveryComplete'{
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnDeliveryComplete' ->
            'v_msg_eventssidecar.v1.OnDeliveryComplete'(Msg, [MsgName], TrUserData);
        'google.protobuf.Timestamp' ->
...
'v_msg_eventssidecar.v1.OnDeliveryComplete'(
    #'eventssidecar.v1.OnDeliveryComplete'{
        timestamp = F1,
        username = F2,
        client_id = F3,
    ...
    if
        F11 == undefined -> ok;
        true -> v_type_string(F11, [session_id | Path], TrUserData)
    end,
    ok;
'v_msg_eventssidecar.v1.OnDeliveryComplete'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'eventssidecar.v1.OnDeliveryComplete'}, X, Path).
...
find_msg_def('eventssidecar.v1.OnDeliveryComplete') ->
    [
        ...
        #field{
            name = session_id, fnum = 11, rnum = 12, type = string, occurrence = optional, opts = []
        }
    ];
...
fqbin_to_msg_name(<<"eventssidecar.v1.OnDeliveryComplete">>) ->
    'eventssidecar.v1.OnDeliveryComplete';
fqbin_to_msg_name(<<"google.protobuf.Timestamp">>) ->
    'google.protobuf.Timestamp';
fqbin_to_msg_name(<<"eventssidecar.v1.MatchedACL">>) ->
    'eventssidecar.v1.MatchedACL';
fqbin_to_msg_name(E) ->
    error({gpb_error, {badmsg, E}}).

msg_name_to_fqbin('eventssidecar.v1.OnDeliveryComplete') ->
    <<"eventssidecar.v1.OnDeliveryComplete">>;
msg_name_to_fqbin('google.protobuf.Timestamp') ->
    <<"google.protobuf.Timestamp">>;
msg_name_to_fqbin('eventssidecar.v1.MatchedACL') ->
    <<"eventssidecar.v1.MatchedACL">>;
msg_name_to_fqbin(E) ->
    error({gpb_error, {badmsg, E}}).
...
get_all_source_basenames() ->
    ["on_delivery_complete.proto", "timestamp.proto", "matched_acl.proto"].
...
%% functions.
get_all_proto_names() -> ["on_delivery_complete", "timestamp", "matched_acl"].
...
get_proto_by_msg_name_as_fqbin(<<"google.protobuf.Timestamp">>) ->
    "timestamp";
get_proto_by_msg_name_as_fqbin(<<"eventssidecar.v1.OnDeliveryComplete">>) ->
    "on_delivery_complete";
get_proto_by_msg_name_as_fqbin(<<"eventssidecar.v1.MatchedACL">>) ->
    "matched_acl";
...
get_protos_by_pkg_name_as_fqbin(<<"eventssidecar.v1">>) -> ["matched_acl", "on_delivery_complete"];
