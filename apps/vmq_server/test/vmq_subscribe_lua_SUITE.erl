...
subscribe_without_remap_test(_) ->
    ...
    {ok, [NodeName, <<"1">>, [TopicWithQoS]]} = eredis:q(whereis(vmq_redis_client), ["FCALL",
                                                                                 fetch_subscriber,
                                                                                 0,
                                                                                 MP,
                                                                                 ClientId]),
...
new_topics_subscribe_test(_) ->
    ...
    {ok, [NodeName, <<"1">>, []]} = eredis:q(whereis(vmq_redis_client), ["FCALL",
                                                                     ...
                                                                     os:system_time(nanosecond),
                                                                     1 | TopicWithQoS1]),
    {ok, [NodeName, <<"1">>, [TopicWithQoS1]]} = eredis:q(whereis(vmq_redis_client), ["FCALL",
                                                                                  subscribe,
                                                                                  0,
                                                                                  MP,
                                                                                  ClientId,
    ...
    {ok, [NodeName, <<"1">>, [TopicWithQoS1]]} = eredis:q(whereis(vmq_redis_client), ["FCALL",
                                                                                  ...
                                                                                  1 | TopicWithQoS2]),
    {ok,
     [NodeName, <<"1">>, [TopicWithQoS1, TopicWithQoS2]]} = eredis:q(whereis(vmq_redis_client), ["FCALL",
                                                                                             subscribe,
                                                                                             0,
                                                                                             MP,
                                                                                             ClientId,
    ...
    {ok,
     [NodeName,
      <<"1">>,
      [TopicWithQoS1, TopicWithQoS3, TopicWithQoS2]]} = eredis:q(whereis(vmq_redis_client), ["FCALL",
                                                                                         subscribe,
                                                                                         0,
                                                                                         MP,
                                                                                         ClientId,
