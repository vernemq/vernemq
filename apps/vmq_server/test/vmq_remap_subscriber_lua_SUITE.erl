...
new_subscriber_clean_session_true_test(_) ->
    ...
    {ok, [undefined, [NodeName, <<"1">>, []]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                  remap_subscriber,
                                                                                  0,
                                                                                  MP,
                                                                                  ClientId,
...
new_subscriber_clean_session_false_test(_) ->
    ...
    {ok, [undefined, [NodeName, undefined, []]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                    remap_subscriber,
                                                                                    0,
                                                                                    MP,
                                                                                    ClientId,
...
clean_session_true_same_node_test(_) ->
    ...
    {ok, [undefined, [NodeName, <<"1">>, []]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                  ...
                                                                                  CS,
                                                                                  os:system_time(nanosecond)]),
    {ok, [<<"1">>, [NodeName, <<"1">>, []]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                remap_subscriber,
                                                                                0,
                                                                                MP,
                                                                                ClientId,
...
clean_session_true_different_node_test(_) ->
    ...
    {ok, [undefined, [NodeName1, <<"1">>, []]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                   remap_subscriber,
                                                                                   0,
                                                                                   MP,
                                                                                   ClientId,
                                                                                   ...
                                                                                   os:system_time(nanosecond)]),
    {ok,
     [<<"1">>, [NodeName2, <<"1">>, []], NodeName1]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                        remap_subscriber,
                                                                                        0,
                                                                                        MP,
                                                                                        ClientId,
...
normal_topic_subscriptions_clean_session_true_test(_) ->
    ...
    {ok, [NodeName, <<"1">>, []]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                     ...
                                                                     Topic,
                                                                     QoS]),
    {ok, [[NodeName, ClientId, QoS]]} = eredis:q(whereis(redis_client), ["FCALL",
...
shared_topic_subscriptions_clean_session_true_test(_) ->
    ...
    {ok, [NodeName, <<"1">>, []]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                     ...
                                                                     QoS]),
    {ok, [[NodeName, Group, ClientId, QoS]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                fetch_matched_topic_subscribers,
                                                                                0,
                                                                                MP,
                                                                                1,
...
clean_session_false_same_node_test(_) ->
    ...
    {ok, [undefined, [NodeName, undefined, []]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                    ...
                                                                                    CS,
                                                                                    os:system_time(nanosecond)]),
    {ok, [<<"1">>, [NodeName, undefined, []]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                  remap_subscriber,
                                                                                  0,
                                                                                  MP,
                                                                                  ClientId,
...
clean_session_false_different_node_test(_) ->
    ...
    {ok, [undefined, [NodeName1, undefined, []]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                     remap_subscriber,
                                                                                     0,
                                                                                     MP,
                                                                                     ClientId,
                                                                                     ...
                                                                                     os:system_time(nanosecond)]),
    {ok,
     [<<"1">>, [NodeName2, undefined, []], NodeName1]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                          remap_subscriber,
                                                                                          0,
                                                                                          MP,
                                                                                          ClientId,
...
normal_topic_subscriptions_clean_session_false_same_node_test(_) ->
    ...
    {ok, [undefined, [NodeName, undefined, []]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                    ...
                                                                                    CS,
                                                                                    os:system_time(nanosecond)]),
    {ok, [NodeName, undefined, []]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                       subscribe,
                                                                       0,
                                                                       MP,
                                                                       ClientId,
    ...
    {ok, [[NodeName, ClientId, QoS]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                         ...
                                                                         Topic]),
    {ok,
     [<<"1">>, [NodeName, undefined, [[Topic, QoS]]]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                          remap_subscriber,
                                                                                          0,
                                                                                          MP,
                                                                                          ClientId,
...
normal_topic_subscriptions_clean_session_false_different_node_test(_) ->
    ...
    {ok, [undefined, [NodeName1, undefined, []]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                     ...
                                                                                     CS,
                                                                                     os:system_time(nanosecond)]),
    {ok, [NodeName1, undefined, []]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                        subscribe,
                                                                        0,
                                                                        MP,
                                                                        ClientId,
                                                                        ...
                                                                        Topic,
                                                                        QoS]),
    {ok, [[NodeName1, ClientId, QoS]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                          fetch_matched_topic_subscribers,
                                                                          0,
                                                                          MP,
                                                                          1,
    ...
    {ok,
     [<<"1">>,
      ...
      NodeName1]} = eredis:q(whereis(redis_client), ["FCALL",
                                                     remap_subscriber,
                                                     0,
                                                     MP,
                                                     ClientId,
                                                     ...
                                                     CS,
                                                     os:system_time(nanosecond)]),
    {ok, [[NodeName2, ClientId, QoS]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                          fetch_matched_topic_subscribers,
                                                                          0,
                                                                          MP,
                                                                          1,
...
shared_topic_subscriptions_clean_session_false_different_node_test(_) ->
    ...
    {ok, [NodeName1, undefined, []]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                        ...
                                                                        SharedTopic,
                                                                        QoS]),
    {ok, [[NodeName1, Group, ClientId, QoS]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                 fetch_matched_topic_subscribers,
                                                                                 0,
                                                                                 MP,
                                                                                 1,
    ...
    {ok,
     [<<"1">>,
      ...
      NodeName1]} = eredis:q(whereis(redis_client), ["FCALL",
                                                     ...
                                                     CS,
                                                     os:system_time(nanosecond)]),
    {ok, [[NodeName2, Group, ClientId, QoS]]} = eredis:q(whereis(redis_client), ["FCALL",
                                                                                 fetch_matched_topic_subscribers,
                                                                                 0,
                                                                                 MP,
                                                                                 1,
