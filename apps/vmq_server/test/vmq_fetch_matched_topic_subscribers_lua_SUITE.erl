...
fetch_matched_topic_subscribers_test(_) ->
    ...
    {ok,[NodeName, <<"1">>,[]]} = eredis:q(whereis(vmq_redis_client), ["FCALL",
                                                                   ...
                                                                   1 | Topic1WithQoS]),
    {ok,[[NodeName, ClientId, QoS_2]]} = eredis:q(whereis(vmq_redis_client), ["FCALL",
                                                                          fetch_matched_topic_subscribers,
                                                                          0,
                                                                          MP,
                                                                          1,
                                                                          Topic1]),
    {ok,[NodeName,<<"1">>,[Topic1WithQoS]]} = eredis:q(whereis(vmq_redis_client), ["FCALL",
                                                                               subscribe,
                                                                               0,
                                                                               MP,
                                                                               ClientId,
                                                                               ...
                                                                               os:system_time(nanosecond),
                                                                               1 | Topic2WithQoS]),
    {ok,[[NodeName, ClientId, QoS_1]]} = eredis:q(whereis(vmq_redis_client), ["FCALL",
                                                                          fetch_matched_topic_subscribers,
                                                                          0,
                                                                          MP,
                                                                          1,
    ...
    {ok,[NodeName,
         <<"1">>,
         [Topic1WithQoS, Topic2WithQoS]]} = eredis:q(whereis(vmq_redis_client), ["FCALL",
                                                                             subscribe,
                                                                             0,
                                                                             MP,
                                                                             ClientId,
    ...
    {ok, [_, _]} = eredis:q(whereis(vmq_redis_client), ["FCALL",
                                                   fetch_matched_topic_subscribers,
                                                   0,
                                                   MP,
                                                   1,
